...
public class DataSiswa extends javax.swing.JPanel {
    ...
    protected void updateDataTabel(){
        ...
        String sql = "SELECT * FROM data_siswa ORDER BY no_id";
        ...
        try{
            ...
            while(hasil.next()){
                ...
                String f = hasil.getString("nilai_semester");
                String g = hasil.getString("prestasi");
                String h = hasil.getString("tingkat_kehadiran");
                String i = hasil.getString("sikap");
                String j = hasil.getString("keaktifan_organisasi");
    ...
    protected void hapusDataCalonPelamar(){
        if(noId != null){
            ...
            if(ok == 0){
                String sql = "DELETE FROM data_siswa WHERE no_id='"+noId+"'";
                try{
    ...
    private void initComponents() {
        ...
        tabelCalonPelamar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.ID", "Nama", "Jenis Kelamin", "Nilai Semester", "No. HP", "Nilai Semester", "Prestasi", "Kehadiran", "Sikap", "Keaktifan Organisasi"
            }
        ));
        ...
        tombolTambah.setText("Tambah Data Siswa");
        ...
        catatan.setText("Catatan : Edit/Hapus data siswa, dengan cara klik data pada tabel terlebih dahulu");
