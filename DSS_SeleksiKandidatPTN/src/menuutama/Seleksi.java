...
public class Seleksi extends javax.swing.JPanel {
    ...
    protected void dataTabel(){
        Object[] Baris = {"Ranking","No.ID","Nama Siswa","No. HP","Hasil Penilaian"};
    ...
    private void initComponents() {
        ...
        judul.setText("  Ranking Hasil Seleksi Kandidat Siswa Terbaik untuk Jalur Undangan PTN");
        ...
        tabelRanking.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ranking", "No.ID", "Nama Siswa", "No. HP", "Hasil Penilaian"
            }
        ));
        ...
        tombolUpdate.setBackground(new java.awt.Color(0, 102, 51));
        ...
        jLabel5.setText("- Ranking diurutkan berdasarkan hasil penilaian terbesar sampai terkecil siswa");
        ...
        tombolLihatPerhitunganAHP.setText("Mulai Penilaian Siswa Terbaik menggunakan AHP");
