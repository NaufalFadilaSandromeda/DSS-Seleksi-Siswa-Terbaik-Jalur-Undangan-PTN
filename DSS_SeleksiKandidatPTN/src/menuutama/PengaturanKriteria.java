...
public class PengaturanKriteria extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Kriteria Lebih penting ke-2");

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel12.setText("Kriteria penting ke-3");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setText("Kriteria cukup penting ke-4");

        cbKriteria1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Nilai Semester", "Prestasi", "Tingkat Kehadiran", "Kecakapan Sikap", "Keaktifan Organisasi" }));

        cbKriteria2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Nilai Semester", "Prestasi", "Tingkat Kehadiran", "Kecakapan Sikap", "Keaktifan Organisasi" }));

        cbKriteria3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Nilai Semester", "Prestasi", "Tingkat Kehadiran", "Kecakapan Sikap", "Keaktifan Organisasi" }));

        cbKriteria4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Nilai Semester", "Prestasi", "Tingkat Kehadiran", "Kecakapan Sikap", "Keaktifan Organisasi" }));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setText("Kriteria biasa ke-5");

        cbKriteria5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kriteria -", "Nilai Semester", "Prestasi", "Tingkat Kehadiran", "Kecakapan Sikap", "Keaktifan Organisasi" }));
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(cbKriteria1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)
